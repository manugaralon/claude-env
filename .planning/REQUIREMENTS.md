...
- [ ] **CLI-01**: `claude-env setup` — global onboarding wizard that generates `~/.claude/` layer
- [ ] **CLI-02**: `claude-env bootstrap` — per-project generation that produces `.claude/` layer
- [ ] **CLI-03**: `--dry-run` flag shows what would be written without writing
